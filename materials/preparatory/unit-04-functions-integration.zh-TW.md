...
狀態：教學草案  
最後更新：2026-08-03  
重大變更摘要：建立函數責任、問題分解、整合開發循環、需求修改、回歸測試與 AI 驗證教材。  
...
必要證據：分解圖、程式、測試表、缺陷紀錄、修改差異、口試回答。
...
禁止：讓 AI 完成核心分解、完整整合作業或即時代答口試。  
必須保留：使用前需求理解、初步分解、自建測試、AI 摘要、驗證與決策。

## 十六、驗收與補驗

- 理解證據：`EV-EX + EV-VI + EV-TR + EV-AI`。
- 行動證據：`EV-IM + EV-TE + EV-DE + EV-MO`。
- 通過：能說明函數責任、追蹤呼叫、完成整合循環、修改需求並驗證 AI 建議。
- 補驗：重構一個過大函數、追蹤新呼叫，或審查另一個錯誤 AI 建議。
