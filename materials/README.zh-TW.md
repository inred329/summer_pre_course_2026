...
如果你是直接進入正式課程，從 F-U00 開始，不需要先讀完前導課程：
...
若正式課程中遇到其他不熟悉的基礎概念，再依需要回到對應前導 Unit 複習即可。
...
每個 Unit 的結尾都有下一單元連結。正常情況下，沿著你目前的路徑一路往下即可，不需要回到 repository 首頁，也不需要閱讀課程憲法、設計文件、審查紀錄、技術驗證或教師文件才能理解教材。
