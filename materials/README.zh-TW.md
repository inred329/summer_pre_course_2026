...
本目錄提供前導課程與正式課程的雙語學生教材，以及自主作業、課堂討論、教師執行、評量與維護資源。

學生教材以獨立閱讀、預測、實作、追蹤、測試、除錯、修改與說明為核心。AI 僅在每個 Unit 結尾作為簡短概念對話對象；不要求固定 prompt、強制保存對話或把 AI 回應視為證據。

## 正式前導教材

| Unit | 中文教材 | English | 核心重點 |
|---|---|---|---|
| P-U01 | [程式如何從文字變成執行結果？](preparatory/unit-01-execution.zh-TW.md) | [How Does Program Text Become an Execution Result?](preparatory/unit-01-execution.en.md) | 原始碼、編譯、可執行檔、預測與錯誤分類 |
...
正式課程包含 F-U01 至 F-U12，涵蓋表示與型別、控制流程、陣列、字串、呼叫堆疊、遞迴、指標、結構、動態記憶體、檔案、模組化、測試除錯與整合應用。
...
- 引導練習、自主練習、測試與需求修改
- 簡短的 AI 概念說明活動
- AI 回應仍需以程式、測試與可重現結果判斷的提醒
- 自我檢核、摘要與前後導覽

學生教材中的自主活動不繳交、不計分、不逐份批改。學生可自行保存預測、程式、錯誤與修正，供課堂討論及複習使用。
...
教師指引負責課堂節奏、作業討論、參與觀察、備援策略與代表性錯誤案例。學生教材不承載教師排程或評分行政內容。
...
既有 AI 使用紀錄模板保留為非強制性的延伸資源，不是每個 Unit 的完成條件，也不要求學生固定使用。

## 正式制度

- 每次課後可安排自主作業，但不繳交、不計分、不逐份批改。
- 下一堂課保留 15–25 分鐘討論前次作業、錯誤、測試與不同解法。
- 不點名計分；出席不等於參與。
- 課堂參與可透過口頭、書面、匿名提問、程式操作、追蹤、測試與小組紀錄展現。
