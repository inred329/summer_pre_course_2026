...
AI 可以作為延伸工具，但不得因位於核心章節主線、完成清單、模板固定欄位或評量欄位而形成隱性必做。所有已審查的前導 Unit 與教材模板均已改為清楚標示、可直接跳過的選用延伸。
...
目前已發現的 P0 問題均已修復。前導 Unit、作業與評量文件、教材入口與模板中的 AI 定位及權威來源問題已完成修正。全庫審查尚未完成，下一批將處理教師文件、正式課程學生教材、設計治理層級與自動驗證，因此 PR 仍維持 Draft。
