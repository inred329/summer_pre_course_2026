...
AI 可以作為延伸工具，但不得因位於核心章節、完成清單、固定模板或評量欄位而成為隱性必做。所有已審查的前導 Unit、正式課程索引與 F-U01 至 F-U11 均已改為可直接跳過的選用延伸。
...
前導 Unit 1–4 與正式課程 F-U01 至 F-U11 目前均具備：
...
目前已發現的 P0 問題均已修復。正式課程索引與 F-U01 至 F-U11 已完成審查；F-U11 已把 AI 移出核心路徑、明確排除 AI 對完成與評量的影響，並修正中文版前後單元的過時導覽連結。全庫審查尚未完成，下一批將處理 F-U12、設計治理層級與自動驗證，因此 PR 仍維持 Draft。