...
AI 可以作為延伸工具，但不得因位於核心章節主線、完成清單、模板固定欄位或評量欄位而形成隱性必做。所有已審查的前導 Unit、正式課程索引、F-U01 與教材模板均已改為清楚標示、可直接跳過的選用延伸。
...
- `materials/formal/unit-02*` 至 `unit-12*`
- 是否仍把 AI 活動放入核心完成主線。
...
目前已發現的 P0 問題均已修復。教師執行指引已完成審查；正式課程索引與 F-U01 的 AI 定位問題已修正。全庫審查尚未完成，下一批將繼續處理 F-U02 至 F-U12、設計治理層級與自動驗證，因此 PR 仍維持 Draft。